...
Shared.RewardAmount = 1000 -- Base Reward
Shared.RewardIncrease = math.random(1000, 2000)
...
Shared.Blip = {
    ...
    Colour = 2,
    Scale = 0.8,
    String = "Pauloo Garbage",
    StringStart = "Kezdő hely",
    StringGarage = "Garázs",
    StringBag = "Szemét"
}

Shared.Locale = {
    Start = "Nyomd meg ~INPUT_CONTEXT~ hogy ~g~elkezd~s~ a kukás munkát",
    Stop = "Nyomd meg ~INPUT_CONTEXT~ hogy ~r~befejezd~s~ a kukás munkát",
    Store = "Nyomd meg ~INPUT_CONTEXT~ hogy eltárold a ~g~kocsit~s~",
    VehicleNear = "Egy kocsi ~r~elfoglalja~s~ a spawn helyet menj arréb vele",
    Info = "Szállj be a kukás kocsiba menj el a kijelölt helyekre",
    TakeBag = "Nyomd meg ~INPUT_CONTEXT~ hogy kivedd a  ~b~szemetet~w~",
    DropBag = "Nyomd meg ~INPUT_CONTEXT~ a kocsi közelében hogy bele dobd a ~b~szemetet~w~",
    InvalidVehicle = "Ez ~r~nem az a kocsi~s~ amivel ~r~kezdted~s~ a munkát",
}
